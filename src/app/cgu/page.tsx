      ...
      <div className="max-w-3xl mx-auto px-5 py-12">
        ...
        <div className="space-y-8 text-gray-700 text-[15px] leading-relaxed">
          <section>
            ...
            <p>Les presentes Conditions Generales d&apos;Utilisation (CGU) regissent l&apos;utilisation de la plateforme Adly, accessible a l&apos;adresse adly.io. En utilisant le service, vous acceptez les presentes conditions dans leur integralite.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">2. Description du service</h2>
            <p>Adly est un outil de generation de publicites assistee par intelligence artificielle. Le service permet aux utilisateurs de creer des visuels publicitaires adaptes a leur marque en s&apos;inspirant de modeles de reference.</p>
          </section>
          ...
          <section>
            ...
            <p>Les publicites generees par Adly appartiennent a l&apos;utilisateur qui les a creees. L&apos;utilisateur est responsable de l&apos;utilisation qu&apos;il fait des contenus generes, notamment en matiere de conformite avec les regles publicitaires des plateformes (Meta, Google, TikTok, etc.).</p>
            <p className="mt-2">Les marques, logos et contenus presents dans la bibliotheque d&apos;inspiration restent la propriete de leurs detenteurs respectifs. Adly ne revendique aucun droit sur ces contenus.</p>
          </section>
          ...
          <section>
            ...
            <p>Adly collecte et traite les donnees personnelles necessaires au fonctionnement du service (adresse email, informations de marque, images uploadees). Ces donnees ne sont ni vendues ni partagees avec des tiers a des fins commerciales.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">7. Limitation de responsabilite</h2>
            <p>Les publicites generees par l&apos;IA peuvent contenir des imperfections. Adly ne garantit pas que les contenus generes seront exempts d&apos;erreurs. L&apos;utilisateur est invite a verifier et adapter les publicites avant toute diffusion.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">8. Modification des CGU</h2>
            <p>Adly se reserve le droit de modifier les presentes CGU a tout moment. Les utilisateurs seront informes de toute modification substantielle.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">9. Contact</h2>
            <p>Pour toute question relative aux presentes CGU, vous pouvez nous contacter a l&apos;adresse : <a href="mailto:contact@adly.com" className="text-blue-500 hover:underline">contact@adly.com</a></p>
          </section>
        </div>
      </div>
    </div>
