    ...
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-5">
        <div className="h-14 flex items-center justify-between">
          ...
          {/* Credits badge — clickable, goes to subscription page */}
          {currentUser && (
            <Link href="/dashboard/subscription" className="hidden sm:flex items-center gap-1.5 bg-violet-50 border border-violet-100 rounded-lg px-3 py-1.5 hover:bg-violet-100 transition-colors cursor-pointer">
